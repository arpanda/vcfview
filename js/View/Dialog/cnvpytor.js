...
define([
  ...
  "dijit/focus",
  "JBrowse/Util",
], function (declare, dom, aspect, Dialog, Button, TextBox, dijitFocus, Util) {
  return declare(null, {
    ...
    show: function () {
      ...
      var fileBox = dojo.create("input", { type: "file" }, container);
        ...
        onClick: () => {
          ...
          // else if they use the local file, use the fileBox
            ...
            var storeConf = {
              ...
              gcContent: conf,
              chunkSizeLimit: 100000000,
              urlTemplate: this.fileBox.files[0],
              tbiUrlTemplates: this.fileBox.files[1],
              urlTemplates,
            };
          } else {
